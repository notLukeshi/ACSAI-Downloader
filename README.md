...
A simple, dedicated browser extension that scans the page [https://circus.francescodb.me/home](https://circus.francescodb.me/home) — the student portal for the **Sapienza University** course **ACSAI (Applied Computer Science and Artificial Intelligence – 33502)** — to automatically find downloadable attachments and save them as a single ZIP file.
